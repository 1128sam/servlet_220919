...
<head>
<meta charset="UTF-8">
<title>Quiz08_1: 자바 제어문 사용 - 책 목록</title>
<link rel="stylesheet"
...
String title = null, author = null, image = null, publisher = null;
for (Map<String, Object> item : list) {
	int id1 = (Integer) item.get("id");
	if (id1 == id) {		
...
<div class="container d-flex">
	...
	<div class="ml-3">
		<div class="display-1"><b><%= title %></b></div>
